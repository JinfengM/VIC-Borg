 ...
 */
BORG_API void BORG_Solution_evaluate(BORG_Solution solution,int argc,char* argv[]);
 ...
 */
BORG_API void BORG_Algorithm_restart(BORG_Algorithm algorithm,int argc,char* argv[]);
 ...
 */
BORG_API void BORG_Algorithm_step(BORG_Algorithm algorithm,int argc,char* argv[]);
 ...
 */
BORG_API BORG_Archive BORG_Algorithm_run(BORG_Problem problem, int maxEvaluations,int argc,char* argv[]);
