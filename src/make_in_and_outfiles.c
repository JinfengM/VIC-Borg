...
**********************************************************************/
{
  ...
  int filenum;
  //fprintf(stderr,"begin to open file1\n");
  sprintf(junk, "%%.%if", options.GRID_DECIMAL);
  sprintf(latchar, junk, soil->lat);
  sprintf(lngchar, junk, soil->lng);
  //fprintf(stderr,"begin to open file2\n");
  /********************************
  Input Forcing Files
  ********************************/
  //fprintf(stderr,"begin to open file3\n");
