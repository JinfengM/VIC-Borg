...
c         PRINT*, 'USAGE:  rout <infile>'
c         STOP
c      ENDIF
c      CALL GETARG(1,FILE_INPUT)
      FILE_INPUT='rout_input.txt'
...
c     note, the arrays are flipped left to right
         PI=ICOL+1-PI
         NAME5 = NAME
c     add XC,YC,SIZE TO CALCULATE geo location
      print*, 'searching catchment...'
         CALL SEARCH_CATCHMENT
     &        (PI,PJ,DIREC,NCOL,NROW,
     &        NO_OF_BOX,CATCHIJ,PMAX,IROW,ICOL,XC,YC,SIZE,NAME5)
 ...
 110  CONTINUE
      ...
      return 
c      STOP
 9001 WRITE(*,*) '...............................................................here CANNOT OPEN: ', FILE_INPUT 
      END
c     ***********************************************
c     FUNCTION  ISALEAP
