...
int vicmain(int nvars,double* vars,int argc, char *argv[])
/**********************************************************************
...
**********************************************************************/
{
 // fprintf(stderr,"in vicmain:call rout_()\n");
 // rout_();  
...
/* 
 ...
 // return 0;
  ...
  //创建新的result存储路径
  fprintf(stderr,"result_dir is %s\n",filenames.result_dir);
  //strcat(filenames.result_dir,"ddd2");
  ...
  while(!MODEL_DONE) {
	...
	//0.910654,0.436423,24.482024,0.502105,3.778949,0.988413,0.413380
...
#endif /* !OUTPUT_FORCE */
  fprintf(stderr,"VIC model water yielding accomplished\n");
  fprintf(stderr,"VIC model water routing operational\n");
  fprintf(stderr,"................rout_() is running...................\n");
  rout_();
  fprintf(stderr,"................rout_() accomplished..................\n");
  fprintf(stderr,"VIC model water routing accomplished\n");
  fprintf(stderr,"Back to vicmain() for calculating objectives");
  return EXIT_SUCCESS;
}	/* End Main Program */
